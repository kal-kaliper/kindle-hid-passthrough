...
_GENERATIONS = [
    ...
    # KOA2, Zelda (2017)
    ('Kindle Oasis 2',  _BRCM_HW, [0x295, 0x296, 0x297, 0x298, 0x2E1, 0x2E2, 0x2E6,
                                   0x2E7, 0x2E8, 0x341, 0x342, 0x343, 0x344, 0x347,
                                   0x34A], 'zelda'),
    # PW4, Rex (2018)
    ('Kindle PW4',      _BRCM_HW, [0x2F7, 0x361, 0x362, 0x363, 0x364, 0x365, 0x366,
                                   0x367, 0x372, 0x373, 0x374, 0x375, 0x376, 0x402,
                                   0x403, 0x4D8, 0x4D9, 0x4DA, 0x4DB, 0x4DC, 0x4DD,
                                   0x2F4], 'rex'),
