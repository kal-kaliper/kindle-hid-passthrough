...
from vendor.bumble import att, core, l2cap, utils
from vendor.bumble.colors import color
from vendor.bumble.core import UUID, InvalidStateError
...
from vendor.bumble.hci import HCI_Constant

if TYPE_CHECKING:
    from vendor.bumble import device as device_module
