...
from vendor.bumble import crypto, utils
...
from vendor.bumble.keys import PairingKeys

if TYPE_CHECKING:
    from vendor.bumble.device import Connection, Device
    from vendor.bumble.pairing import PairingConfig
