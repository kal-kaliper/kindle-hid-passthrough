...
from vendor.bumble import hci, l2cap, utils
from vendor.bumble.colors import color
from vendor.bumble.core import UUID, InvalidOperationError, ProtocolError
from vendor.bumble.hci import HCI_Object

# -----------------------------------------------------------------------------
# Typing
# -----------------------------------------------------------------------------
if TYPE_CHECKING:
    from vendor.bumble.device import Connection
