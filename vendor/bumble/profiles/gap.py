...
from vendor.bumble.core import Appearance
...
from vendor.bumble.gatt_adapters import (
    DelegatedCharacteristicProxyAdapter,
    UTF8CharacteristicProxyAdapter,
)
from vendor.bumble.gatt_client import CharacteristicProxy, ProfileServiceProxy, ServiceProxy
