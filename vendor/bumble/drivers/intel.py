...
from vendor.bumble import core, hci, utils
from vendor.bumble.drivers import common

if TYPE_CHECKING:
    from vendor.bumble.host import Host
...
def intel_firmware_dir() -> pathlib.Path:
    ...
    """
    from vendor.bumble.drivers import project_data_dir
